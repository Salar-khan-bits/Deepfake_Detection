...
class Config:
    ...
    # timm ViT / SigLIP-style backbone (OpenCLIP ViT-B-16-SigLIP-384)
    model_name: str = "ViT-B-16-SigLIP-384"
    pretrained: bool = True
    freeze_backbone: bool = False

    # Training (ViT-B/16 @ 384: smaller batch + grad accum to keep effective bs=32 on 12 GB)
    batch_size: int = 16
    ...
    experiment_name: str = "deepfake_siglip_vitB16_384"
